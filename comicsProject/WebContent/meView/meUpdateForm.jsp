...
<body>
	<div class="row col-sm-offset-<%=myOffset%> col-sm-<%=mySetGrid%>"
		...
		<form action="<%=MyCtrlCommand%>meUpdate" name="form" id="form" method="post">
		<input type="hidden" id="falsepass" name="falsepass" value="false">
		<input type="hidden" id="falserepass" name="falserepass" value="true">
		<input type="hidden" id="falsenickname" name="falsenickname" value="true">
		<input type="hidden" id="falsephone2" name="falsephone2" value="true">
		<input type="hidden" id="falsephone3" name="falsephone3" value="true">
			<div class="panel">
				...
				<h4>회원 정보 수정</h4>
					<div style="margin-top: -10px;">
						...
						<input type="text" class="form-control"
							...
							name="id1" id="id1" readonly="readonly" value="${bean.id}">
							&nbsp;&nbsp;
					...
					<div class="form-inline">
						<input type="text" class="form-control"
							...
							name="name" id="name" readonly="readonly" value="${bean.name}">
							&nbsp;&nbsp;
					...
					<div class="form-inline">
						<input type="text" class="form-control"
							...
							name="birth" id="birth" readonly="readonly" value="${bean.birth}">
							&nbsp;&nbsp;
					...
					<div class="form-inline">
						<input type="text" class="form-control"
							...
							name="email1" id="email1" value="${bean.email1}"> &nbsp;@&nbsp; 
							<select
					...
					<div class="form-inline">
						<input type="text" size="5" class="form-control" id="phone1"
							name="phone1" value="010" style="border-color: black;" value="${bean.phone1}"> -
						<input type="text" size="5" class="form-control" id="phone2"
							name="phone2" style="border-color: black;" value="${bean.phone2}"> - <input
							type="text" size="5" class="form-control" id="phone3"
							name="phone3" style="border-color: black;" value="${bean.phone3}">
							&nbsp;&nbsp;
					...
					<div class="form-inline">
						<input type="text" size="8" class="form-control" id="zipcode"
							...
							placeholder="우편번호" readonly="readonly" value="${bean.zipcode}">
							&nbsp;&nbsp;&nbsp; 
					...
					<div class="form-inline">
						<input type="text" size="40%" class="form-control" id="address2"
							name="address2" placeholder="상세주소" style="border-color: black;" value="${bean.address2}">
					</div>
					&nbsp;&nbsp;
			...
			<div class="row col-sm-offset-6">
				<div class="form-group">
					<button type="submit" class="btn btn-success btn-lg" onclick="return finallCheck();">수정하기</button>
				</div>
				</div>
		</form>
	</div>
...
$(document).ready(function() {	
	var isTrue = false;
		$('#email2 option').each(function (index){
			if( $(this).val() == '${bean.email2}' ){
...
function finallCheck(){
	...
	if(falsepass == "true" && falserepass == "true" && falsenickname == "true" && falsephone2 == "true" && falsephone3 == "true"){
