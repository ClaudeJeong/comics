...
public class RecordManageController implements SuperController {
	...
	public void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		int totalCount = rcdao.selectTotalCount("members", mode, keyword + "%");
		
		String contextPath = request.getContextPath();
		String myurl = contextPath + "/ComicsCtrl?command=rcManage";
		...
		List<Member> lists = rcdao.SelectMemberDataList(pageInfo.getBeginRow(), pageInfo.getEndRow()
				,mode, keyword + "%");
		...
		String url="/record/rcManage.jsp?" + parameters.toString(); 
